...
const fr: Dict = {
  ...
  deliveryTimingNoticeNotesHint: "Besoin d'un délai plus long ou d'une demande particulière ? Indiquez-la dans la note de commande. Le commerçant vous confirmera ce qui est possible.",
...
const en: Dict = {
  ...
  deliveryTimingNoticeNotesHint: "Need a later delivery or have a specific request? Add it to your order note. The merchant will confirm what is possible.",
...
const ar: Dict = {
  ...
  deliveryTimingNoticeNotesHint: "هل تحتاج إلى موعد لاحق أو لديك طلب محدد؟ أضفه إلى ملاحظة الطلب. سيؤكد التاجر ما هو ممكن.",
