...
// reste un test de RÉGRESSION P3-A2 : il continue de vérifier qu'AUCUN
// fichier nommé "p3a2" n'existe, et que le compte total n'a plus bougé
// DEPUIS les ajouts attendus de P3-B0/P3-B1/ORDERS SERVICE_ROLE SELECT
// HARDENING v1/P3-B2/P3-B3/P3-B4.
test("archi: aucun fichier SQL ajouté par P3-A2 (nombre inchangé depuis PAYMENT P3-B0/P3-B1/ORDERS ACL HARDENING/P3-B2/P3-B3/P3-B4, aucun nom contenant p3a2)", () => {
