...
// compte total à 64. Ce test reste un test de RÉGRESSION P3-A1 : il
...
test("archi: aucun fichier SQL ajouté par P3-A1 (nombre inchangé depuis PAYMENT P3-B0, aucun nom contenant p3a1)", () => {
