#!/usr/bin/env node
// =============================================================================
// Scanym — CGV ENGINE ENRICHMENT v2 — SQL-HARNESS RENDER HELPER
//
...
// supabase/tests/seller-legal-profile-cgv-engine-v2-1-check.sh so that the
...
//
// Usage:
//   node --experimental-strip-types seller-legal-profile-cgv-engine-v2-1-render-helper.mjs \
